...
const portfolio = [
  {
    ...
    client: "M. Abdou, CEO",
    description:
      "A seamless travel booking platform with real-time updates and user-friendly interface.",
    image: "/project1.webp",
    content: (
      <>
        <p className="mb-4">
          We built a full-stack travel booking platform using Next.js and Supabase. The site
          features real-time trip management, secure user dashboards, and an admin backend.
        </p>
  ...
  },
  {
    ...
    client: "A. Ilhsan, CEO",
    description:
      "A fully functional eCommerce store with smooth UI, fast checkout, and secure payments.",
    image: "/project.webp",
    content: (
      <>
        <p className="mb-4">
          A scalable eCommerce storefront built with performance in mind. Includes product
          management, cart logic, and Stripe integration for secure payments.
        </p>
        <ul className="list-disc list-inside space-y-2">
  ...
  },
  {
    ...
    client: "E. Hicham, CEO",
    description:
      "A modern transport management system optimizing logistics and customer experience.",
    image: "/project2.webp",
    content: (
      <>
        <p className="mb-4">
          We developed a transport and logistics management system tailored for a fleet-based
          business.
        </p>
        <ul className="list-disc list-inside space-y-2">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          A full digital package from keyword research to server management. Helped increase Google
          visibility and backend stability.
        </p>
        <ul className="list-disc list-inside space-y-2">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          Asara was looking for aggressive brand visibility and conversion-based marketing. We
          combined web dev with performance marketing to drive growth.
        </p>
        <ul className="list-disc list-inside space-y-2">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          This project focused on collecting high-quality leads via landing pages and pushing data
          into a custom-built mobile app.
        </p>
        <ul className="list-disc list-inside space-y-2">
