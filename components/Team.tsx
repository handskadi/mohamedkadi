            ...
            <div className="p-6 text-center md:text-left">
              ...
              <div className="mt-4 flex justify-center md:justify-start space-x-4">
                ...
                {member.social.github && (
                  <a href={member.social.github} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black">
                    <FaGithub size={20} />
                  </a>
                )}
                {member.social.stackoverflow && (
                  <a href={member.social.stackoverflow} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-600">
                ...
                {member.social.facebook && (
                  <a href={member.social.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600">
                    <FaFacebook size={20} />
                  </a>
                )}
                {member.social.instagram && (
                  <a href={member.social.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-pink-600">
                    <FaInstagram size={20} />
                  </a>
                )}
              </div>
