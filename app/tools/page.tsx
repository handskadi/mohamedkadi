...
import { Image, ScanLine, FileText } from "lucide-react";
...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Free converters and optimizers to compress images, PDFs, and more — all private and fast.",
  ...
  const tools = [
    {
      ...
      icon: <Image alt="Image Compressor & WebP Converter" className="w-8 h-8" />,
    },
    {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-[100px]">
      ...
      <div className="mt-20 text-center text-sm text-gray-500">
        <p>
          💡 More tools coming soon — built by{" "}
          <span className="font-semibold text-blue-600">Mohamed Kadi</span> to save time & improve
          your web workflow.
        </p>
      </div>
    </div>
