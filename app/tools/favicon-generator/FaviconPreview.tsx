    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <div className="bg-gray-200 rounded-t-lg shadow-inner p-2 w-52">
                        <div className="flex items-center justify-between bg-white rounded px-2 py-1 border border-gray-300">
                            {faviconURL && (
                                <img src={faviconURL} alt="favicon" className="w-4 h-4 mr-1" />
                            )}
            ...
            <div>
                ...
                <div className={`w-full max-w-xl border rounded shadow px-4 py-3 ${isDark ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
