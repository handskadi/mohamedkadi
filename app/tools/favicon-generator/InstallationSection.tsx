  ...
  return (
    <section className="mt-20 space-y-8 bg-white border border-gray-200 rounded-xl p-6">
      ...
      <p className="text-sm text-gray-500">
        💡 <strong>Recommendation:</strong> Place all these icons in your website's public folder or
        root if using a static setup. If using Next.js or Vite, put them inside your{" "}
        <code>public/</code> folder so they’re accessible from <code>/favicon-32x32.png</code>, etc.
      </p>
    </section>
  );
}
